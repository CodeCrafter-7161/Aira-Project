      ...
      <div style={{ width: '100%', maxWidth: 1400, margin: '10px auto', position: 'relative' }}>
         ...
         <style>{`
          ...
          @media (max-width: 1024px) {
             ...
             .center-decor { display: none; }
             .diagnostic-card { padding: 20px !important; }
       ...
       `}</style>
         ...
         <div className="matrix-container">
            ...
            {/* CENTER: THE HUD & CORE */}
            <div className="hide-mobile" style={{ position: 'relative', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
               <div className="center-decor" style={{ position: 'absolute', top: 0, left: 0, width: 40, height: 40, borderTop: '2px solid var(--teal)', borderLeft: '2px solid var(--teal)' }} />
               <div className="center-decor" style={{ position: 'absolute', top: 0, right: 0, width: 40, height: 40, borderTop: '2px solid var(--teal)', borderRight: '2px solid var(--teal)' }} />
               <div className="center-decor" style={{ position: 'absolute', bottom: 0, left: 0, width: 40, height: 40, borderBottom: '2px solid var(--teal)', borderLeft: '2px solid var(--teal)' }} />
               <div className="center-decor" style={{ position: 'absolute', bottom: 0, right: 0, width: 40, height: 40, borderBottom: '2px solid var(--teal)', borderRight: '2px solid var(--teal)' }} />
