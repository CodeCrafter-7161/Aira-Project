...
export default function HeroVisual() {
  ...
  useEffect(() => {
    setMounted(true);
    const handleResize = () => {
      setScale(window.innerWidth < 640 ? window.innerWidth / 640 : 1);
    };
    handleResize();
  ...
  return (
    <div
      ...
      style={{ 
        position: 'relative', width: '100%', height: 600 * scale, 
    ...
    >
      ...
      <div className="core-t" style={{
        ...
        padding: 'var(--space-4)', 
        display: 'grid', 
        gridTemplateColumns: 'minmax(240px, 1fr) 1.2fr', 
        ...
        <div className="obs-card core-t" style={{
           ...
           padding: 'var(--space-3)',
           transform: `translateZ(${hovering ? 40 : 10}px) translateX(${hovering ? -10 : 0}px) translateY(${hovering ? -10 : 0}px)`,
        ...
        <div className="obs-card core-t" style={{
           ...
           padding: 'var(--space-3)',
           transform: `translateZ(${hovering ? 60 : 15}px) translateX(${hovering ? -15 : 0}px) translateY(${hovering ? 10 : 0}px)`,
        ...
        <div className="obs-card core-t" style={{
           ...
           padding: 'var(--space-3)',
           transform: `translateZ(${hovering ? 50 : 5}px) translateX(${hovering ? 15 : 0}px)`,
           ...
           <div className="heading-card" style={{ borderBottom: '1px solid var(--teal-12)', paddingBottom: 'var(--space-1)', marginBottom: 6 }}>Step 3: Your Report</div>
           
           {/* Score + Summary Row */}
           <div style={{ display: 'flex', gap: 10, marginBottom: 8 }}>
             {/* Viability Score Ring */}
             <div style={{ position: 'relative', width: 44, height: 44, flexShrink: 0 }}>
               <svg viewBox="0 0 52 52" style={{ width: 44, height: 44, transform: 'rotate(-90deg)' }}>
               ...
               <div style={{ position: 'absolute', inset: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'var(--font-mono)', fontSize: 11, fontWeight: 700, color: hovering ? 'var(--teal)' : 'var(--text-muted)', transition: 'color 0.6s' }}>
                 {hovering ? '82' : '--'}
               </div>
             </div>
             <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
               <div style={{ fontFamily: 'var(--font-mono)', fontSize: 8, textTransform: 'uppercase', letterSpacing: 1, color: 'var(--teal-40)', marginBottom: 1 }}>Viability Score</div>
               <div style={{ fontSize: 10, color: hovering ? 'var(--teal)' : 'var(--text-muted)', fontWeight: 600, transition: 'color 0.6s' }}>{hovering ? 'High Potential' : 'Pending...'}</div>
             </div>
           </div>
