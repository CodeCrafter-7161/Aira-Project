...
export default function RegisterPage({ onNavigate }) {
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', backgroundColor: 'var(--bg-primary)', position: 'relative', overflow: 'hidden' }}>
      ...
      {/* --- RIGHT PANEL (FORM) --- */}
      <div className="auth-container" style={{ width: '100%', maxWidth: 600, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '40px', position: 'relative', zIndex: 1 }}>
      ...
      <style>{`
        ...
        @media (max-width: 480px) {
            ...
            .auth-box { padding: 32px 24px !important; }
        }
      `}</style>
    </div>
  );
